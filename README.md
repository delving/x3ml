...
* **Transparency**
	...
	The most important feature of X3ML is its general application to mapping creation and execution and hopefully its longevity.  People must understand how it works and we must be very certain that it produces the right results.
	
	The cleaner the core design of this engine and X3ML language, and the clearer its documentation, the more readily it will get traction and become the basis for future mappings.

* **Collaborative Mapping Memory**

	The X3ML mapping descriptions must lend themselves to being stored and handled by collaborative tools, as well as written by hand.  This was the motivation for choosing a simple syntax in XML.
...
* **Re-use of Technologies**
	...
	* **XStream** - easy reading/writing of XML
	
	* **URI templates** - standardized URI generation
	
	* **Jena** - in-memory building of graph for RDF output
